...
<title>@Admin - Pin for management | Post primary school education center.</title>
...
function loadDetailedPinc($batchno){
	...
	<thead><th>S/no</th><th>Pin SN</th><th>Pin</th><th>Active status</th><th>lease period</th><th>No. of Login</th><th>student ID</th><th>Session</th><th>Term</th><th>card status</th></thead>
    <tbody>
	<?php
		while($val=mysqli_fetch_array($k)){
			...
			?>
			<tr>
            <td><?php echo $j;?></td><td><?php echo "{$val['pinSN']}";?></td><td><?php echo "{$val['pin']}";?></td><td><?php echo "{$val['activate_for_use_status']}";?></td><td><?php echo "{$val['leasing_period']}";?></td><td><?php echo "{$val['no_of_login']}";?></td><td><?php echo "{$val['student_id']}";?></td><td><?php echo "{$val['session']}";?></td><td><?php echo "{$val['term']}";?></td><td><?php echo "{$val['card_status']}";?></td>
            </tr>
			<?php
			$i++;
		}
